...
export const KDF_ARGON2ID_V1 = "argon2id-v1" as const;
 ...
 */
export const ARGON2ID_DEFAULT_PARAMS: Argon2idParams = {mKiB: 19_456, t: 2, p: 1};

/** RFC 9106 second recommended option (64 MiB, t=3) for non-interactive use. */
export const ARGON2ID_HIGH_PARAMS: Argon2idParams = {mKiB: 65_536, t: 3, p: 1};
 ...
 */
export function deriveKeyArgon2id(opts: DeriveKeyArgon2idOpts): DerivedKeyArgon2id {
